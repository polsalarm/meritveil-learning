...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      deriveOwnerCommitment(context, ...args_1) {
        return { result: pureCircuits.deriveOwnerCommitment(...args_1), context };
      },
      increment: (...args_1) => {
        if (args_1.length !== 1) {
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initialOwnerCommitment_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _deriveOwnerCommitment_0(secret_0) {
    return this._persistentHash_0([new Uint8Array([109, 101, 114, 105, 116, 118, 101, 105, 108, 58, 99, 111, 117, 110, 116, 101, 114, 45, 111, 119, 110, 101, 114, 58, 118, 49, 0, 0, 0, 0, 0, 0]),
                                   secret_0]);
  }
  _increment_0(context, partialProofData) {
    const candidate_0 = this._deriveOwnerCommitment_0(this._secretKey_0(context,
                                                                        partialProofData));
    __compactRuntime.assert(this._equal_0(candidate_0,
...
export const pureCircuits = {
  deriveOwnerCommitment: (...args_0) => {
    if (args_0.length !== 1) {
      throw new __compactRuntime.CompactError(`deriveOwnerCommitment: expected 1 argument (as invoked from Typescript), received ${args_0.length}`);
    }
    const secret_0 = args_0[0];
    if (!(secret_0.buffer instanceof ArrayBuffer && secret_0.BYTES_PER_ELEMENT === 1 && secret_0.length === 32)) {
      __compactRuntime.typeError('deriveOwnerCommitment',
                                 'argument 1',
                                 'counter.compact line 17 char 1',
                                 'Bytes<32>',
                                 secret_0)
    }
    return _dummyContract._deriveOwnerCommitment_0(secret_0);
  }
};
